...
namespace SharpLog
{
    ...
    internal static class Formatter
    {
        ...
        /// <param name="log">The log.</param>
        /// <returns>The formatted log.</returns>
        internal static string Format([NotNull] Log log)
        {
            ...
            for (int i = 0; i < format.Length; i++)
            {
                ...
                else
                {
                    ...
                    switch (format[i])
                    {
                        ...
                        case 'T':
                            {
                                (_, string prefix, string suffix, string indentation, (int, char) padLeft, (int, char) padRight, int index) = GetProperties(format, i);
                                i = index;
                                if (log.Tag == null)
                                {
                                    break;
                        ...
                        default:
                            {
                                string placeholder = format[i].ToString();
                                (_, string prefix, string suffix, string indentation, (int, char) padLeft, (int, char) padRight, int index) = GetProperties(format, i);
                                i = index;
        ...
        private static (
            ...
            (int, char) padRight,
            int index)
            GetProperties(string format, int index)
        {
